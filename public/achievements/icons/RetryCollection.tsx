        ...
        <svg width="100%" height="100%" viewBox="0 0 512 512">
            <g>
                <g fill-rule="evenodd" clip-rule="evenodd">
                    <path
                        fill="#eceff1"
                        d="M124.655 8H431.2c2.754 0 5.124.982 7.071 2.929l56.146 56.145c1.947 1.947 2.929 4.317 2.929 7.071V494c0 5.508-4.492 10-10 10h-362.69c-5.508 0-10-4.492-10-10V18c-.001-5.508 4.491-10 9.999-10z"
                        opacity="1"
                        data-original="#eceff1"
                    ></path>
                    <path
                        fill="#d1d1d6"
                        d="M306 8h125.2c2.754 0 5.124.982 7.071 2.929l56.146 56.145c1.947 1.947 2.929 4.317 2.929 7.071V494c0 5.508-4.492 10-10 10H306z"
                        opacity="1"
                        data-original="#d1d1d6"
                    ></path>
                    <g fill="#a79ba7">
                        <path
                            d="M435.342 8.867a10.025 10.025 0 0 1 2.929 2.062l56.146 56.145a10.025 10.025 0 0 1 2.062 2.929h-56.136a5.01 5.01 0 0 1-5-5V8.867zM306 436.494a8 8 0 0 1 0-16h113.25a8 8 0 0 1 0 16zM192.75 236.245a8 8 0 0 1 0-16h226.5a8 8 0 0 1 0 16zm0 66.75a8 8 0 0 1 0-16h226.5a8 8 0 0 1 0 16zm0 66.749a8 8 0 0 1 0-16h226.5a8 8 0 0 1 0 16z"
                            fill="#a79ba7"
                            opacity="1"
                    ...
                    <circle
                        ...
                        r="100"
                        fill="#fe646f"
                        transform="rotate(-87.14 114.666 341.68)"
                        opacity="1"
                        data-original="#fe646f"
                    ></circle>
                    <path
                        fill="#fd4755"
                        d="M114.655 241.743c55.229 0 100 44.772 100 100s-44.771 100-100 100z"
                        opacity="1"
                        data-original="#fd4755"
                    ></path>
                    <path
                        fill="#eceff1"
                        d="M145.534 285.529a7.971 7.971 0 0 1 12.938 9.312L83.841 398.724a7.97 7.97 0 0 1-11.125 1.812 7.97 7.97 0 0 1-1.813-11.125zm-60.528 2.983c-9.787 0-17.719 7.932-17.719 17.719 0 9.786 7.932 17.719 17.719 17.719 9.786 0 17.719-7.932 17.719-17.719 0-9.786-7.932-17.719-17.719-17.719zm59.299 71.025c-9.786 0-17.719 7.932-17.719 17.719s7.932 17.719 17.719 17.719 17.719-7.932 17.719-17.719-7.932-17.719-17.719-17.719z"
                        opacity="1"
                        data-original="#eceff1"
                    ></path>
                </g>
