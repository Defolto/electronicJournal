export default function Play({ className }: { className?: string }) {
   return (
      ...
      >
         <g>
            <path d="m284.2 178-58-33.6-57.6-33.2c-5.6-3.2-12-4-17.6-2.4-5.6 1.6-10.8 5.2-14 10.8-1.2 1.6-1.6 3.6-2.4 5.6-.4 1.2-.4 2.8-.8 4.4v137.6c0 6.4 2.8 12.4 6.8 16.4 4.4 4.4 10 6.8 16.4 6.8 3.6 0 11.2-3.2 13.2-4.4l56.8-32.8h.4l.4-.4 58.8-34c5.6-3.2 9.2-8.4 10.8-14.4.4-1.2.4-2.8.4-4.4 0-13.2-13.6-22-13.6-22zm-8 23.6-58 33.6c-.4 0-.8.4-.8.4l-56.8 32.8c-.4.4-2.4 1.2-3.2 1.2s-1.6-.4-2.4-.8c-.4-.4-.8-1.6-.8-2.4V130s0-.4.4-.4c0 0 .4-.4.4-.8.4-.4 1.2-.8 1.6-1.2h2c.4.4.8.4 1.2.8l56.8 32.8c.4.4.8.4.8.4h.4l58 33.6c.8.4 2.4 1.6 2.4 2.8 0 1.6-1.2 3.2-2 3.6z"></path>
            <path d="M339 58.4C300.6 19.6 249.8 0 199 0S97.4 19.2 58.6 58C19.8 97.2.2 148 .2 198.8s19.2 101.6 58 140.4 89.6 58 140.4 58c50.8 0 101.6-19.2 140.4-58 38.8-38.8 58-89.6 58-140.4S377.8 97.2 339 58.4zm-14 266.4c-34.8 34.8-80.4 52.4-126 52.4-45.6 0-91.2-17.6-126-52.4-35.2-34.8-52.4-80.4-52.4-126 0-45.6 17.6-91.2 52.4-126s80.4-52.4 126-52.4c45.6 0 91.2 17.6 126 52.4s52.4 80.4 52.4 126c0 45.6-17.2 91.2-52.4 126z"></path>
         </g>
      </svg>
   )
}
